...
const stats = [
  {
    icon: <FaFileAlt />,
    number: "100.123",
    label: "Hồ sơ bệnh án đã được lưu trữ",
  },
  {
    icon: <FaShieldAlt />,
    number: "98.5%",
    label: "Hồ sơ được bảo mật an toàn tuyệt đối",
  },
  {
    icon: <FaUniversity />,
    number: "168",
        ...
        <div className="hp-container">
          <div className="hp-top-grid">
                ...
                <div className="hp-hero-inner">
                  <div className="hp-hero-text">
                    <h1 className="hp-hero-h1">
                      Chăm sóc sức khỏe thông minh – Quản lý an toàn
                    </h1>
                    <p className="hp-hero-desc">
                      Hệ thống quản lý và truy xuất hồ sơ bệnh án điện từ 
                      giúp bệnh nhân và cơ sở y tế quản lý thông tin sức khỏe 
                      hiệu quả, bảo mật và thuận tiện.
                    </p>
                    <div className="hp-hero-btns">
                      <Link to="/verify" className="hp-btn-white">
                        <FaCheckCircle /> Tra cứu hồ sơ ngay
                      </Link>
            ...
            <div className="hp-verify-card">
              <h3 className="hp-verify-title">TRA CỨU HỒ SƠ BỆNH ÁN</h3>
              ...
              {verifyTab === "qr" ? (
                <div className="hp-qr-panel">
                  <p className="hp-qr-hint">
                    Quét mã QR trên thẻ bệnh nhân để truy xuất hồ sơ bệnh án
                  </p>
                ...
                <div className="hp-code-panel">
                  <p className="hp-qr-hint">
                    Nhập mã hồ sơ trên thẻ bệnh nhân 
                  </p>
                  <input
                    type="text"
          ...
          <div className="hp-cards-row">
            ...
            <div className="hp-card">
              <div className="hp-card-hd">
                <span className="hp-card-ttl">HỒ SƠ MỚI CẬP NHẬT</span>
                ...
                {newCerts.map((cert, i) => (
                  <div key={i} className="hp-cert-row">
                    ...
                    <div className="hp-cert-meta">
                      <span className="hp-cert-badge">Đã đồng bộ</span>
            ...
            <div className="hp-card">
              <div className="hp-card-hd">
                <span className="hp-card-ttl">HƯỚNG DẪN TRA CỨU</span>
